...
var data = {
  squares: [
    ...
    { square: 'open chrome' },
    { square: 'transfers call to manager' },
    { square: 'happy 3 hours anniversary' },
    { square: 'edna screams "get off my lawn!"' },
    { square: 'driving to Target' },
    { square: 'each and everything' },
    { square: 'scammer laughs' },
    { square: 'scammer speaks another language' },
    { square: "that's great" },
